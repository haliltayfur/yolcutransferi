  ...
  return (
    <section className="w-full max-w-4xl mx-auto border border-[#bfa658] rounded-3xl shadow-2xl px-6 md:px-12 py-14 bg-gradient-to-br from-black via-[#19160a] to-[#302811] mt-16 mb-10">
      ...
      <form onSubmit={handleSubmit} className="w-full flex flex-col gap-3 bg-black/70 rounded-2xl p-6 border border-[#bfa658]/60 shadow" encType="multipart/form-data">
        ...
        {/* Dosya seç ufak sola yaslı */}
        <div className="flex flex-row items-center gap-2">
          <label className="relative" style={{width:120}}>
            <input
              type="file"
              name="ek"
              ref={fileInput}
              ...
              style={{width:120,height:28,cursor:"pointer"}}
            />
            <div
              className="flex items-center justify-start px-2 py-1 rounded-md bg-[#bfa658] text-black font-semibold text-xs shadow cursor-pointer hover:bg-yellow-600 transition"
              style={{minHeight:28,width:120}}
            >
              {selectedFileName
